...
Overall top three: `latent32 · seed 42`, `residual2 · seed 43`, `balanced · seed 42`. Target/season best: `residual2_z32 · seed 43`. See the [model differences table](../b0-configuration-comparison.md#model-differences) and the canonical report’s equal-target WIS-ratio selection rule.
